...
def login():
    ...
    if form.validate_on_submit():
        ...
        print("Login efetuado!", user.username, "OK")
...
def delete_book(book_id):
    ...
    #Remover todas as referências mnas outras tabelas
...
def update_book(book_id):
    book = Book.query.get_or_404(book_id)
    form = BookForm(obj=book)# Já preenche as informações no form quando encontra.
...
def update_person(person_id):
    ...
    form = PersonForm(obj=person)# Já preenche as informações no form quando encontra.
